...
process convert_gtf_to_df{
    ...
    script:
    """
    workflow-glue convert_gtf_to_df -i ${params.genome_gtf} -o ${params.output_dir}converted_gtf.csv || echo "Conversion failed" >> ${params.output_dir}error_logs/gtf_conversion.log
    """
}
